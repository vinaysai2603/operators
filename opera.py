...
354000.00
'''
# Input the salary of senior players
X = int(input().strip())

# Input the salary of junior players
Y = int(input().strip())

# Number of senior and junior players
senior_players = 6
junior_players = 5

# Contribution calculation
senior_contribution = (50 / 100) * X * senior_players
junior_contribution = (40 / 100) * Y * junior_players
